...
export const Search = ({ designers, products }: SearchProps): JSX.Element => {
  ...
  return (
    <section className={styles['container']}>
      ...
      <div className={`${styles['results-designers']} ${styles[`${designers.length === 1 ? 'single-item' : 'more-items'}`]}`}>
      ...
      <div className={styles['results-products']}>
        <Grid className='grid' type="products" items={products} />
      </div>
    </section>
  );
};
